...
import { getTS0Type, getTSType } from "./createTSTableClass.js";

export function createTSTableVariantClass(scheme            , libFSPath        , 
        tableDefVariant                 )       {
    createClass(scheme, libFSPath, tableDefVariant);
}


function createClass(scheme            , libFSPath        , tableDefVariant                 )       {
    let content =
