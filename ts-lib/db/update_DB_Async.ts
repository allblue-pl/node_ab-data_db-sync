import { DatabaseInfo, DatabaseVersion, type DataScheme, FieldInfo, IndexInfo } from "ab-data";
import TableInfo from "ab-data/ts-lib/TableInfo.ts";
...
export default async function update_DB_Async(scheme: DataScheme, 
        connectionInfo: DBConnectionInfo): Promise<void> {
...
async function createDatabaseInfo_Async(db: Database): Promise<DatabaseInfo> {
