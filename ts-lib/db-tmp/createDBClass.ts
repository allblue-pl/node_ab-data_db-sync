...
// export function createDBClass(destFSPath: string, tableDef: TableDef): void {
//     createClass(destFSPath, tableDef);
// }


// function createClass(destFSPath: string, tableDef: TableDef): void {
//     let content =
...
// function getTS0Type(field: ABDField): string {
//     if (field instanceof f.ABDAutoIncrementId)
//         return `"number"`;
//     else if (field instanceof f.ABDBlob)
